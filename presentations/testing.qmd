...
::: fragment
We **cannot** simultaneously make them low *Thus, we fix one them...*
:::
...
Thus we [**fix the Type 1 Error**]{.underline} [**(**$\alpha$**)**]{.underline}, but [**Type 2 Error (**$\beta$**)**]{.underline} [**still can be large!**]{.underline}

...
```{r}
ggsave(
  filename = 'code/lec_output/bigplot.png', # specify the filename (path to file)
...
```{r}
pdf("code/lec_output/dodge_barplot.pdf", width = 6, height = 6)
...
# Choose the plot for your data ([data-to-viz.com](https://www.data-to-viz.com/))

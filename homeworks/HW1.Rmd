...
#### 5. Check for missing values (`NA`) in the dataset (how many in each row?).
...
#### 10. Round Height in meters to two decimal places (*e.g.* 1.4567 -\> 1.46)
...
#### 12. Identify the row with the maximum `Height` and print it.
...
#### 18. Show rows of the 3 tallest and 3 the shortest elephants
